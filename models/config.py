...
from pydantic import BaseModel, PositiveInt, NonNegativeInt, ConfigDict, Field, PositiveFloat, NonNegativeFloat
...
class Web3Settings:
    irys_rpc_url: str
    verify_balance: bool
    faucet_balance_threshold: NonNegativeFloat = 0.0
    top_up_balance_threshold: NonNegativeFloat = 0.0
...
class LoopSettings:
    ...
    loop_interval_seconds: NonNegativeInt = 0
